...
export function findRecipeByName(inputValue, addedIngredientsList, removedIngredientsList) {
  ...
  export function findRecipeByIngredient(inputValue, addedIngredientsList, removedIngredientsList){
     recettes.recipes.filter(recipe => recipe.ingredients.some(ingredient => ingredient.name.toLowerCase().includes(inputValue.toLowerCase())))
  }